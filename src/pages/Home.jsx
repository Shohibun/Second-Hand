...
//   applyFilter = () => {
//     const { data, filterNama, filterHargaMin, filterHargaMax, filterKategori } =
//       this.state;

//     const filterData = data.filter((datas) => {
//       const isNamaMatch =
//         filterNama === "" ||
//         datas.nama.toLowerCase().includes(filterNama.toLowerCase());
//       const isHargaMatch =
//         (filterHargaMin === "" ||
//           parseFloat(datas.harga) >= parseFloat(filterHargaMin)) &&
//         (filterHargaMax === "" ||
//           parseFloat(datas.harga) <= parseFloat(filterHargaMax));
//       const isKategoriMatch =
//         filterKategori === "" ||
//         datas.kategori.toLowerCase() === filterKategori.toLowerCase();

//       return isNamaMatch && isHargaMatch && isKategoriMatch;
//     });
...
export default function Home() {
  ...
  const [allData, setAllData] = useState(data.datas);
  console.log(allData);
    ...
    <div className="custom-overflow-x-hidden">
      ...
      <div className="container mt-5 pt-4">
        ...
        >
          ...
          <button
            className="btn btn-outline-danger ml-2 custom-border-button-2 my-2 my-sm-0"
            type="submit"
          >
            Reset
          </button>
