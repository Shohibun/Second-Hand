...
export default function DashboardProductSeller() {
            ...
            <div className="col-md-4 px-5">
              <div className="container-fluid custom-top-minus">
                <div className="border px-3 py-3 bg-white custom-border-auth">
                  ...
                  <form action="/dashboard-jual-seller">
                    <button className="mt-3 form-group fixed-bottom font-weight-bold text-white border-0 py-2 w-75 mx-auto custom-border-auth custom-button-auth custom-font-1">
                      Terbitkan
                    </button>
                  </form>
                </div>
